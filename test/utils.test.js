...
import { isValidFormat, isValidIP, parseAddressAndPort, parseSocksConfig, sha224Hash, formatIdentifier, base64ToArray, isValidDomain } from '../src/utils.js';
...
describe('utils.js', () => {
    ...
    describe('parseSocksConfig', () => {
        ...
        it('should throw on invalid format', () => {
             expect(() => parseSocksConfig('invalid')).toThrow();
        });
    });
